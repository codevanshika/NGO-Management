...
<%@page import="in.co.nog.mgt.controller.DonoThingsCtl"%>
...
<br>
 <nav
	...
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Donate Things</li>
	</ol>
	</nav>
...
<div class="col-md-5">
    <div class="form-area">  
        <form role="form" action="<%=NGOView.DONOR_THINGS_CTL%>" method="post" >
        
       <jsp:useBean id="bean" class="in.co.nog.mgt.bean.DonorThingsBean"
        ...
        <br style="clear:both">
                    <h3 style="margin-bottom: 15px; text-align: left: ;">Donate Things</h3>
                		...
                		<div class="form-group">
							...
							<div class="form-group">
								<input type="text" class="form-control"  name="description"
									placeholder="What do you want to donate.." value="<%=DataUtility.getStringData(bean.getDescription())%>" > 
        					...
        					<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=DonoThingsCtl.OP_SAVE%>">&nbsp;or&nbsp;
								<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=DonoThingsCtl.OP_RESET%>">
        </form>
    </div>
</div>
</div> </div> <!--feedback-->
