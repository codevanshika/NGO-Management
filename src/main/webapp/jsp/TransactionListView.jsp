...
<form action="<%=NGOView.TRANSACTION_LIST_CTL%>" method="post">
		<div id="feedback">
			<div class="container">
				<div class="col-md-9">
					<div class="form-area">
							
							<h3 style="margin-bottom: 15px; text-align: left;">Transaction List</h3>
							<div class="form-row">
							...
							<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=TransactionListCtl.OP_RESET%>">
							</div>
							</div>
					</div>
				</div>
