...
import in.co.nog.mgt.controller.BaseCtl;
import in.co.nog.mgt.controller.NGOView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(NGOView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
