...
public class RoleModel 
{
    ...
    public long add(RoleBean bean) throws ApplicationException,
        ...
        try {
            ...
            PreparedStatement pstmt = conn
                    .prepareStatement("INSERT INTO N_ROLE VALUES(?,?,?,?,?,?,?)");
            pstmt.setInt(1, pk);
     ...
     */
	    public void delete(RoleBean bean) throws ApplicationException {
	        ...
	        try {
	            ...
	            conn.setAutoCommit(false); // Begin transaction
	            PreparedStatement pstmt = conn
	                    .prepareStatement("DELETE FROM N_ROLE WHERE ID=?");
    ...
    public RoleBean findByPK(long pk) throws ApplicationException {
        ...
        StringBuffer sql = new StringBuffer("SELECT * FROM N_ROLE WHERE ID=?");
        RoleBean bean = null;
        Connection conn = null;
        try {
            conn = JDBCDataSource.getConnection();
    ...
    public void update(RoleBean bean) throws ApplicationException,
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("UPDATE N_ROLE SET NAME=?,DESCRIPTION=?,CREATEDBY=?,MODIFIEDBY=?,CREATEDDATETIME=?,MODIFIEDDATETIME=? WHERE ID=?");
    ...
    public List search(RoleBean bean, int pageNo, int pageSize)
        ...
        StringBuffer sql = new StringBuffer("SELECT * FROM N_ROLE WHERE 1=1");
        if (bean != null) {
            if (bean.getId() > 0) {
    ...
    public List list(int pageNo, int pageSize) throws ApplicationException {
        ...
        ArrayList list = new ArrayList();
        StringBuffer sql = new StringBuffer("select * from N_ROLE");
        // if page size is greater than zero then apply pagination
        if (pageSize > 0) {
            // Calculate start record index
            pageNo = (pageNo - 1) * pageSize;
