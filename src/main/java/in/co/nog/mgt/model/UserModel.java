...
import in.co.nog.mgt.exception.RecordNotFoundException;
...
public class UserModel {
	...
	public Integer nextPK() throws DatabaseException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("SELECT MAX(ID) FROM N_USER");
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("INSERT INTO N_USER VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			pstmt.setInt(1, pk);
			...
			pstmt.setString(10,bean.getIdProof());
	...
	public void delete(UserBean bean) throws ApplicationException {
		...
		try {
			conn = JDBCDataSource.getConnection();
			conn.setAutoCommit(false); // Begin transaction
			PreparedStatement pstmt = conn.prepareStatement("DELETE FROM N_USER WHERE ID=?");
	...
	public UserBean findByLogin(String login) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM N_USER WHERE LOGIN=?");
		UserBean bean = null;
		Connection conn = null;
		...
		try {
			...
			while (rs.next()) {
				...
				bean.setIdProof(rs.getString(10));
				bean.setImage(rs.getString(11));	
	...
	public UserBean findByPK(long pk) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM N_USER WHERE ID=?");
		UserBean bean = null;
		Connection conn = null;
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE N_USER SET FIRSTNAME=?,LASTNAME=?,LOGIN=?,PASSWORD=?,DOB=?,MOBILENO=?,ROLEID=?,"
					+ "GENDER=?,IdProof=?,image=?,"
			...
			pstmt.setString(9,bean.getIdProof());
	...
	public List search(UserBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM N_USER WHERE 1=1");
		...
		if (bean != null) {
			...
			if (bean.getIdProof()!=null && bean.getIdProof().length()>0) {
				sql.append("AND IDPROOF LIKE  '"+bean.getIdProof()+"%'");
			}
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		ArrayList list = new ArrayList();
		StringBuffer sql = new StringBuffer("select * from N_USER");
		// if page size is greater than zero then apply pagination
		if (pageSize > 0) {
			// Calculate start record index
			pageNo = (pageNo - 1) * pageSize;
	...
	public UserBean authenticate(String login, String password) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM N_USER WHERE LOGIN = ? AND PASSWORD = ?");
		UserBean bean = null;
		Connection conn = null;
	...
	public List getRoles(UserBean bean) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM N_USER WHERE role_Id=?");
		Connection conn = null;
